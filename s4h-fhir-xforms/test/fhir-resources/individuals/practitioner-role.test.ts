...
import { FHIR_PractitionerRole_T } from "../../../src/fhir-resources/individuals/practitioner-role";
import { assertEitherRight, consoleLogInspect, shouldDump } from "../../utils";


describe("PractitionerRole suite", () => {
    ...
    it("test role", () => {
        ...
        const roleParsed = FHIR_PractitionerRole_T.decode(role);
        if (shouldDump()) {
            consoleLogInspect(PathReporter.report(roleParsed));
        }

        assertEitherRight(roleParsed);
    });
